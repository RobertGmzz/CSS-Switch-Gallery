...
function MagicButtons(){
    ...
    return(
        <div className="flex justify-between gap-x-5 *:px-4 *:py-2 text-sm font-semibold text-white *:bg-gray-900 *:rounded-2xl *:border-2 *:border-gray-700 *:hover:scale-105 *:active:scale-100 *:cursor-pointer">
